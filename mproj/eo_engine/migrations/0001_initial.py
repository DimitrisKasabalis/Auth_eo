# Generated by Django 3.2.9 on 2021-12-13 00:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_date', models.DateField(help_text='product reference date', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crawler_type', models.TextField(choices=[('SCRAPY_SPIDER', 'Using Scrappy Spider'), ('OTHER (SFTP)', 'Using sftp Crawler'), ('OTHER (WAPOR)Wapor on demand', 'Other Wapor'), ('NONE', 'Not using crawling')], default='NONE')),
            ],
            bases=('eo_engine.eogroup',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='pipelines_from_input', to='eo_engine.eogroup')),
        ...
        migrations.AddConstraint(
            model_name='pipeline',
            constraint=models.UniqueConstraint(fields=('input_group', 'output_group'), name='unique input/output'),
        ),
        migrations.AddConstraint(
            model_name='pipeline',
        ...
        migrations.AddField(
            model_name='eosource',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='eo_engine.eosourcegroup'),
        ),
        migrations.AddField(
            model_name='eoproduct',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='eo_engine.eoproductgroup'),
        ),
