...
urlpatterns = [
    ...
    path('configure/eo_source/<str:group_name>',views.configure_eosourcemeta,name='configure-eosource-meta'),
    ...
    path('trigger/eoproduct_generation/<str:filename>', views.trigger_generate_eoproduct,  name='trigger-eoproduct_generation'),
